...
from gestures.network.metric.loss import LossType
...
_classifier = {
    "model": TinyRadarNN,
    "model_cfg": {},
    # "model_ck": "/home/netanel/code/outputs/classifier/TinyRadar_loss_TinyLoss_1/ds_1_original_dim_True_pix_norm_Normalization.Range_0_1/2024-01-23_17:29:27/modelacc",
    "model_ck": None,
...
_sr = {
    ...
    "model_ck": "/home/netanel/code/outputs/sr/Drln_2_loss_L1_0.26_MSSSIM_0.74/ds_4_original_dim_False_pix_norm_Normalization.Range_0_1/2024-01-29_19:43:01/modelloss",
    # "model_ck": "/Users/netanelblumenfeld/Desktop/bgu/Msc/code/outputs/sr/Drln_2_loss_L1_0.26_MSSSIM_0.74/ds_4_original_dim_False_pix_norm_Normalization.Range_0_1/2024-01-29_19:43:01/modelloss",
    "loss": {
        "metrics_names": [LossType.L1, LossType.MSSSIM],
        "metric_wights": [0.26, 0.74],
    },
    "optimizer": {"class": torch.optim.Adam, "args": {"lr": lr}},
    "accuracy": {"metrics_names": [LossType.L1], "metric_wights": [1]},
}
...
# training config
training_cfg = {"lr": lr, "epochs": 200, "batch_size": batch_size}
